...
quiet_cmd__Users_josuetorresf2_Desktop_Fall_21_3300_project_project_vendor_cache_ruby_2_6_0_gems_libv8_node_15_14_0_1_src_node_15_14_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION generating: "$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc" "$(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S" $@
cmd__Users_josuetorresf2_Desktop_Fall_21_3300_project_project_vendor_cache_ruby_2_6_0_gems_libv8_node_15_14_0_1_src_node_15_14_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/tools/v8_gypfiles; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot" --turbo_instruction_scheduling "--target_os=mac" "--target_arch=arm64" --startup_src "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc" --embedded_variant Default --embedded_src "$(obj).$(TOOLSET)/v8_snapshot/geni/embedded.S" --no-native-code-counters
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: export XCODE_VERSION_ACTUAL := 1300
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: TOOLSET := $(TOOLSET)
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S: 72beb40051568c6daa07b102b9d7741bcedbdc91.intermediate
	@:
.INTERMEDIATE: 72beb40051568c6daa07b102b9d7741bcedbdc91.intermediate
72beb40051568c6daa07b102b9d7741bcedbdc91.intermediate: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,touch)
	$(call do_cmd,_Users_josuetorresf2_Desktop_Fall_21_3300_project_project_vendor_cache_ruby_2_6_0_gems_libv8_node_15_14_0_1_src_node_15_14_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
action__Users_josuetorresf2_Desktop_Fall_21_3300_project_project_vendor_cache_ruby_2_6_0_gems_libv8_node_15_14_0_1_src_node_15_14_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
...
$(OBJS): | $(action__Users_josuetorresf2_Desktop_Fall_21_3300_project_project_vendor_cache_ruby_2_6_0_gems_libv8_node_15_14_0_1_src_node_15_14_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(builddir)/libv8_snapshot.a: | $(action__Users_josuetorresf2_Desktop_Fall_21_3300_project_project_vendor_cache_ruby_2_6_0_gems_libv8_node_15_14_0_1_src_node_15_14_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__Users_josuetorresf2_Desktop_Fall_21_3300_project_project_vendor_cache_ruby_2_6_0_gems_libv8_node_15_14_0_1_src_node_15_14_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(builddir)/mksnapshot $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp
